export default function OilConceptExplainer() {
  return (
    <section className="rounded-xl border border-blue-100 bg-blue-50 p-6 text-blue-950">
      <h2 className="text-xl font-black">Why can a large oil shock have a smaller direct CPI effect?</h2>
      ...
      <div className="mt-5 rounded-lg border border-blue-200 bg-white p-4 font-mono text-sm leading-7 text-slate-800">
